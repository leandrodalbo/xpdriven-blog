  ...
  <article className="flex flex-col justify-center items-center min-h-screen bg-gray-800 text-gray-300 p-6 md:p-8 lg:p-10 space-y-6">
    ...
    <div className="space-y-4 text-lg sm:text-xl text-gray-300">
      <p className="text-md sm:text-xl leading-relaxed text-left text-gray-300">
        <span className="text-gray-100 font-semibold">♻️ TDD</span> helps you
        write better code by ensuring tests come first. Pioneered by{" "}
        <span className="text-gray-100 font-semibold">Kent Beck</span>, leads to
      ...
      <p className="text-md sm:text-xl leading-relaxed text-left text-gray-300">
        ...
        emphasizes collaboration, continuous feedback, and rapid iterations.
        It’s all about delivering high-quality software faster.
      </p>

      <p className="text-md sm:text-xl leading-relaxed text-left text-gray-300">
        <span className="text-gray-100 font-semibold">🧼 Clean Code</span> is a
        core principle in software development.
        <span className="text-gray-100 font-semibold"> Robert C. Martin</span>’s
        books, like{" "}
        <span className="text-gray-100 font-semibold">Clean Code</span>, teach
        us how to make our code more readable, maintainable, and flexible.
      </p>

      <p className="text-md sm:text-xl leading-relaxed text-left text-gray-300">
        <span className="text-gray-100 font-semibold">📢 Agile</span> promotes
        flexibility, continuous improvement, and close collaboration with
        customers. It’s a powerful way to build software that adapts to change.
      </p>
    </div>
